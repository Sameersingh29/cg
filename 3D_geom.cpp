...
glColor3f(1,1,0);//yelllow;
divide_triangle(v[0],v[3],v[2],k);
...
glOrtho(-2,2,-2,2,-2,2);//left right bottom top near far (near far will be flipped)
glMatrixMode(GL_MODELVIEW);
}

int main(int argc, char **argv){
//get input of k here
cout<< "Enter no. of subdividsions: ";
cin>> k;
glutInit(&argc,argv);
glutInitDisplayMode(GLUT_RGB|GLUT_SINGLE|GLUT_DEPTH);
glutInitWindowSize(500,500);
glutCreateWindow("3D Geometric Operations- Sierpinski");
myinit();
